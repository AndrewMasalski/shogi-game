...
namespace BoardControl.UnitTests.Controls
{
  ...
  public class ShogiHandTest
  {
    ...
    public void FlatTest()
    {
      ...
      board.Black.Hand.Add(PT.馬);
      Assert.AreEqual(PT.角, hand.Items[0].PieceType);
      ...
      board.White.Hand.Add(PT.歩);
      board.White.Hand.Add(PT.歩);
      board.White.Hand.Add(PT.歩);
      board.White.Hand.Add(PT.歩);
      Assert.AreEqual(4, hand.Items.Count);
      Assert.IsTrue(board.White.Hand.Remove(PT.歩));
    ...
    public void GroupTest()
    {
      ...
      Assert.AreEqual(PieceColor.Black, handNest.PieceColor);
      Assert.AreEqual(PT.歩, handNest.PieceType);
    ...
    public void TestOrderedGroupsMode()
    {
      ...
      board.Black.Hand.Add(PT.桂);
      board.Black.Hand.Add(PT.桂);
      board.Black.Hand.Add(PT.桂);
      board.Black.Hand.Add(PT.桂);
      Assert.AreEqual(9, hand.Items.Count);

      Assert.AreEqual(PT.王, hand.Items[0].PieceType);
      Assert.AreEqual(PT.玉, hand.Items[1].PieceType);
      Assert.AreEqual(PT.飛, hand.Items[2].PieceType);
      Assert.AreEqual(PT.角, hand.Items[3].PieceType);
      Assert.AreEqual(PT.金, hand.Items[4].PieceType);
      Assert.AreEqual(PT.銀, hand.Items[5].PieceType);
      Assert.AreEqual(PT.桂, hand.Items[6].PieceType);
      Assert.AreEqual(PT.香, hand.Items[7].PieceType);
      Assert.AreEqual(PT.歩, hand.Items[8].PieceType);
