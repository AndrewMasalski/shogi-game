...
namespace Yasc.Utils
{
  public static class EnumerableExtensions
  {
    ...
    public static IEnumerable<TResult> Pairs<TSource, TResult>(this IEnumerable<TSource> list, Func<TSource, TSource, TResult> converter)
    {
